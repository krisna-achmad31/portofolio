...
const List<Project> kProjects = [
  ...
  Project(
    ...
    category: 'Hardware',
    featured: true,
    screenshots: ['images/rfid_1.png','images/rfid_2.png',],
    icon: Icons.qr_code_scanner_rounded,
    iconImage: 'images/rfid.png',
  ...
  Project(
    ...
    category: 'IoT',
    featured: true,
    screenshots: ['images/iotstadium_1.png','images/iotstadium_2.png',],
    icon: Icons.sensors_rounded,
    iconImage: 'images/iotstadium.png',
  ...
  Project(
    ...
    category: 'IoT',
    featured: true,
    screenshots: ['images/noto_1.png','images/noto_2.png',],
    iconImage: 'images/noto.png',
  ...
  Project(
    ...
    screenshots: ['images/hall_aircon_1.png','images/hall_aircon_2.png',],
  ...
  Project(
    ...
    category: 'Mobile',
    featured: false,
    screenshots: ['images/collins_1.png','images/collins_2.png',],
  ...
  Project(
    ...
    category: 'Mobile',
    featured: false,
    screenshots: ['images/vingeek_1.png','images/vingeek_2.png',],
  ...
  Project(
    ...
    category: 'Mobile',
    featured: false,
    screenshots: ['images/propnex_1.png','images/propnex_2.png',],
  ...
  Project(
    ...
    category: 'Healthcare',
    featured: false,
    screenshots: ['images/seraphim_1.png','images/seraphim_2.png',],
  ...
  Project(
    ...
    category: 'Healthcare',
    featured: false,
    screenshots: ['images/indihealth_1.png','images/indihealth_2.png',],
  ...
  Project(
    ...
    category: 'Fintech',
    featured: false,
    screenshots: ['images/vonix_1.png','images/vonix_2.png',],
  ...
  Project(
    ...
    category: 'Mobile',
    featured: false,
    screenshots: ['images/ping_1.png','images/ping_2.png',],
  ...
  Project(
    ...
    category: 'Mobile',
    featured: false,
    screenshots: ['images/inkelud_1.png','images/inkelud_2.png',],
