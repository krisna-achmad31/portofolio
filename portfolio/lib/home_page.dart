                ...
                showModalBottomSheet(
                  ...
                  builder: (_) => Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        _MobileNavLink(label: 'About', onTap: () { Navigator.pop(context); onAbout(); }),
                        _MobileNavLink(label: 'Projects', onTap: () { Navigator.pop(context); onProjects(); }),
                        _MobileNavLink(label: 'Skills', onTap: () { Navigator.pop(context); onSkills(); }),
                        _MobileNavLink(label: 'Contact', onTap: () { Navigator.pop(context); onContact(); }),
                      ],
                    ),
                  ),
                );
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: _hovering
                  ? widget.project.gradient[0].withValues(alpha: 0.5)
            ...
            Wrap(
              ...
              children: [
                ...
                _ContactButton(
                  ...
                  onTap: () => _launchURL(
                      'https://www.linkedin.com/in/achmadyukrisna'),
                ),
                _ContactButton(
